...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
	...
	$sql_insert="INSERT INTO `dataacquisition` (`InstitutionNumber`, `FilingPeriodEmploymentNumber`, `SurveyPeriodEmploymentNumber`, `OtherReason`, `EmploymentNumberReleaseType`, `FirstReason`, `SecondReason`, `ThirdReason`, `CollectionTime`, `SurveyPeriodID`, `CityCheck`, `ProvinceCheck`) VALUES('".$InstitutionNumber."', ".$FilingPeriodEmploymentNumber.", ".$SurveyPeriodEmploymentNumber.", '".$OtherReason."','".$EmploymentNumberReleaseType."', '".$FirstReason."', '".$SecondReason."','".$ThirdReason."', '".$CollectionTime."', ".$SurveyPeriodID." ,'0' ,'0')";
