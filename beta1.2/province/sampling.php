...
<head>
	...
	$sql = 'SELECT CityGovermentName,count(CompanyNumber) AS num FROM company INNER JOIN citygoverment ON company.CompanyAddr like concat("%", citygoverment.CityGovermentName, "%") GROUP BY CityGovermentName';
	$result=mysql_query($sql);
	$nums=array();
	while($row=mysql_fetch_array($result))
	{
		$nums[$row['CityGovermentName']]=$row['num'];
	}
	echo '
	<script>
		$(function () {
