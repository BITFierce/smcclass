...
<body>
	<?php
		...
		$CityCheck=$row['CityCheck'];
		$ProvinceCheck=$row['ProvinceCheck'];
	...
	<div class="container">
		...
		<div class="content">
			...
			<div class="cstyle">
				...
				<span style="width:500px;"><?php  if($CityCheck=='0') 
													echo "未审核";
												  else
													echo "通过";
										   ?>
			...
			<div class="cstyle">
				...
				<span style="width:500px;"><?php  if($ProvinceCheck=='0') 
													echo "未审核";
												  else
													echo "通过";
										   ?>
			...
			<div class="cstyle">
				<span style="width:150px;">填报时间</span>
				<span style="width:500px;"><?php echo $CollectionTime; ?></span>
			</div>
		</div>
